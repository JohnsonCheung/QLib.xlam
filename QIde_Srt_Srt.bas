Attribute VB_Name = "QIde_Srt_Srt"
Option Explicit
Private Const CMod$ = "MIde_Srt."
...
SrcSrt = SplitCrLf(LineszJnLinesItr(SrtedSrcDic(Src).Items, vbDblCrLf))
End Function

Function SrtedMdDicInPj() As Dictionary
Set SrtedMdDicInPj = SrtedMdDiczPj(CurPj)
End Function
...
Function SrtedSrcLinesInMd$()
SrtedSrcLinesInMd = SrtedSrcLineszMd(CurMd)
End Function
