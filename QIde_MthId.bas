...
Public Const DoczMthQLin$ = "newtype A3DotLin.  Q for qualified.  Fmt is PjNm.ShtMdTy.MdNm.MthLin"
...
Public Const DoczMthQidLin$ = "newtype A6DotLin.  Q is for qualify.  It is a variant of MthLin of format Pj.MdTy.MdNm.MthId.ShtMthMdy.ShtMthKd.MthRst"
Public Const DoczMthMLin$ = "M for Modified.  Fmt is [ShtMthMdy.ShtMthKd.MthNmRst].  MthNmRst is MthMLin with MthMdy and MthTy removed."
Public Const DoczMthSQMLin$ = "It is A5DotStr.  Q for qualified.  M for Modified.  Fmt is [MthSrtKey.PjNm.ShtMdTyNm.MdNm.ShtMthMdy.ShtMthKd.MthNmRst]."
Public Const DoczMthSrtKey$ = "It is Str.  Fmt is [MthMdy:MthNm]"
...
End Function
Private Function DicOf_PjMdTyMdNm_To_MthQLy(MthQLy$()) As Dictionary
...
Dim I
For Each I In DicOf_PjMdTyMdNm_To_MthQLy(MthQLy).Items
