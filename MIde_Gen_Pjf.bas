...
Public Const ™Srcp$ = "Src-Pth:Src.p. It a Pth with Fdr is PjFn and ParFdr is SrcRoot"
Public Const ™DistRoot$ = "It a Pth with Fdr eq '.dist'"
Public Const ™DistPth$ = "It an InstPth with Fdr is InstPth and ParFdr is DistRoot"
Public Const ™PthInst$ = "It a InstFdr of under a given Pth"
Public Const ™InstPth$ = "It a Pth with Fdr is InstNm"
