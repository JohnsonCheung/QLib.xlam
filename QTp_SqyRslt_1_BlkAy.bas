Attribute VB_Name = "QTp_SqyRslt_1_BlkAy"
Option Explicit
Private Const CMod$ = "MTp_SqyRslt_1_BlkAy."
...
Dim L$: L = A(0)
Dim Sy$(): Sy = SyzSsLin("?SEL SEL ?SELDIS SELDIS UPD DRP")
If HitPfxSy(L, Sy) Then IsSqLy = True: Exit Function
End Function
