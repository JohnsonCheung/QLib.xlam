Attribute VB_Name = "QXls_Rg"
Option Explicit
Private Const CMod$ = "MXls_Rg."
...
Function CrtLozSq(Sq(), At As Range, Optional LoNm$) As ListObject
Set CrtLozSq = CrtLozRg(RgzSq(Sq(), At), LoNm)
End Function
Function CrtLozRg(Rg As Range, Optional LoNm$) As ListObject
