...
End Function
Sub ThwIfDifDic(A As Dictionary, B As Dictionary, Fun$, Optional N1$ = "A", Optional N2$ = "B")
...
Function MaxSizAyDic%(AyDic As Dictionary) ' MthDic is DicOf_MthNm_zz_MthLinesAy
