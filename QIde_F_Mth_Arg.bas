Attribute VB_Name = "QIde_F_Mth_Arg"
Option Explicit
Option Compare Text
...
Private Function ShtArgSfx$(ArgSfx$)
Select Case True
Case ArgSfx = ""
...
Private Function ShfArgSfx$(OLin$)
Dim P%: P = InStr(OLin, "=")
If P > 0 Then
...
Private Function ShfShtArgSfx$(OLin$)
