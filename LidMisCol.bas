...
With Me
    ...
    Set .EptFset = EptFset
    Set .ActFset = ActFset
    If EptFset.Minus(ActFset).Cnt = 0 Then Thw CSub, "No missing Fny, should not create this LidMisCol instance", "EptFset ActFset", EptFset.Sy, ActFset.Sy
End With
Set Init = Me
End Function
