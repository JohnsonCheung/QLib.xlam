...
Public Const DoczMdDNm$ = "Full: Md-Dot-Nm.  It is Either MdNm or PjNm-Dot-MdNm."
...
Dim D As Dictionary: Set D = DiceKeySet(MthNmDic(Src), MthNmSet): 'Brw D: Stop
