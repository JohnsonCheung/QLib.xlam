Attribute VB_Name = "QIde_Ens_CLib_Cmp_LibNm11"
Option Explicit
Private Const CMod$ = "MIde_Ens_CLib_Cmp_LibNm11."
...
Dim I
For Each I In CmpAy
    If LibNm(CvCmp(I), EiByDic) = "" Then
        PushI NoLibMdNy, CvCmp(I).Name
    End If
Next
End Function

Function LibNm$(A As VBComponent, B As EmLibNmTy)
LibNm = Bef(A.Name, "_")
End Function
...
LibDef = _
FmtSyT2(AddSy( _
AddPfxzSy(C_MdNmToLibNmLy, "MdNm "), _
AddPfxzSy(C_MdPfxToLibNmLy, "MdPfx ")))
End Function
