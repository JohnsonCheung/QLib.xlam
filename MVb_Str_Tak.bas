...
Function PfxAySpc$(S$, PfxAy$()) ' Return Fst ele-P of [PfxAy] if [S] has pfx ele-P and a space
Dim P
For Each P In PfxAy
    If HasPfx(S, P & " ") Then PfxAySpc = P: Exit Function
Next
End Function

Function PfxzAy$(S$, PfxAy$()) ' Return Fst ele-P of [PfxAy] if [S] has pfx ele-P
Dim P
For Each P In PfxAy
...
Function SfxzAySpc$(S$, SfxAy$()) ' Return Fst ele-P of [PfxAy] if [S$] has pfx ele-P
Dim Sfx$, I
For Each I In SfxAy
    Sfx = I
