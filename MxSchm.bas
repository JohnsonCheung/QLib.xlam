...
ThwMsg CSub, FmtQQ("Fld(?) not in EF and not StdFld", F)
End Function
...
ThwMsg CSub, FmtQQ("Fld(?) of Ele(?) not found in EleLy-of-EleAy(?) and not StdEle", F, Ele, TLin(EleNy))
End Function
...
Private Function MsgLinTyEr$(A(), Ty$)
