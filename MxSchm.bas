...
Dim E As Drs:       E = F_SubDrs_ByC_EqExl(XD, "T1", "Ele")
Dim F As Drs:       F = F_SubDrs_ByC_EqExl(XD, "T1", "Fld")
Dim D As Drs:       D = F_SubDrs_ByC_EqExl(XD, "T1", "Des")
Dim T As Drs:       T = F_SubDrs_ByC_EqExl(XD, "T1", "Tbl")
