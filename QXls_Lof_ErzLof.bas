...
ErzBet = AddSyAp(ErzBetDup, ErzBetFny, ErzBetTermCnt)
End Property
...
Dim L$()
'L = Cor
ErzCor = AddSyAp(ErzCorDup(L), ErzCorFld(L), ErzCorVal(L))
'Cor = L
End Property
...
Dim T1$, I
For Each I In SyzSsLin(LofT1nnzSng) 'It is for [SngFldLin] only
    T1 = I
...
ErzVal = AddSyAp(ErzValzNotNum, ErzValzNotInLis, ErzValzFml, ErzValzNotBet)
End Property
...
Dim T
For Each T In SyzSsLin("Wdt Lvl")
Next
End Function
...
Dim ErzFny$(): ErzFny = MinusAy(Fny, A_Fny)
