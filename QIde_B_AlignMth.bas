...
Dim CrChg As S1S2s: CrChg = S1S2szDif(CrEpt, CrAct)           ' CmNm RmkLines ! Only those need to change
If True Then
    XBox "#1 CrEpt":     X FmtS1S2s(CrEpt):    XLin
    XBox "#2 CrAct":     X FmtS1S2s(CrAct):    XLin
    XBox "#3 CrChg":     X FmtS1S2s(CrChg):    XLin
    Brw XX
End If
