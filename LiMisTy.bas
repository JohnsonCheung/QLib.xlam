...
Private A_Tyc() As LiMisTyc
Friend Function Init(Fx, Fxn, Wsn, Tyc() As LiMisTyc) As LiMisTy
With Me
    .Fx = Fx
    .Fxn = Fxn
    .Wsn = Wsn
...
Set Init = Me
End Function
Property Get TycAy() As LiMisTyc()
TycAy = A_Tyc
End Property
...
Private Function MisMsgColMsgAy(A() As LiMisTyc) As String()
Dim J%, O$()
For J = 0 To UBound(A)
