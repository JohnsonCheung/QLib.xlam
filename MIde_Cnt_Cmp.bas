...
CmpCnt.Init NModzPj(A), NClszPj(A), NDoczPj(A), NOthCmpzPj(A)
End Function
'----------------------------------------------
...
Function NDoczPj%(A As VBProject)
NDoczPj = NCmpzTy(A, vbext_ct_Document)
End Function
...
NOthCmpzPj = NCmpzPj(A) - NClszPj(A) - NModzPj(A) - NDoczPj(A)
End Function
