...
Function SrcLineszMFi$(A As CodeModule, B As FEIx)
If IsFEIxzEmp(B) Then Exit Function
'SrcLineszMFi = A.Lines(B.FmNo, B.Cnt)
End Function

Function SrczMFi(A As CodeModule, B As FEIx) As String()
'SrczMFi = SplitCrLf(SrcLineszMdFEIx(A, B))
End Function
