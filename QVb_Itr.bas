...
Function IsSomFFalsezItrPred(Itr, Pred$) As Boolean
Dim I
For Each I In Itr
    If Not Run(Pred, I) Then IsSomFFalsezItrPred = True: Exit Function
Next
End Function

Function IsSomFTruezItrPred(Itr, Pred$) As Boolean
Dim I
For Each I In Itr
    If Run(Pred, I) Then IsSomFTruezItrPred = True: Exit Function
Next
End Function
